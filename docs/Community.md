...
Wij zijn natuurlijk benieuwd naar hoe je deze leermodule hebt ervaren. Heb je na het afronden suggesties of opmerkingen, wil je ons feedback geven? [Maak dan een issue aan op GitHub](https://github.com/PDOK/leermodule-location-api/issues). 
...
**Bouw met ons mee** aan de community en [neem contact met ons op](https://formulieren.kadaster.nl/contact-pdok)! Ook staan we open voor **[pull requests](https://github.com/PDOK/leermodule-location-api/pulls)**. 
