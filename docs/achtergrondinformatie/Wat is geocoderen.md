...
Geocoderen is het automatisch vertalen van een locatiebeschrijving — bijvoorbeeld “Dorpsstraat 12, 1234 AB” — naar een positie op de aarde, meestal weergegeven als lengte- en breedtegraad (coördinaten). Het stelt systemen in staat om adressen, objecten of plaatsen te koppelen aan een specifieke plek op een kaart. Dit maakt toepassingen mogelijk zoals navigatie, ruimtelijke analyses, locatiegebaseerd zoeken en het visualiseren van data.

Waarom is geocoderen belangrijk?
Geocoderen vormt de basis voor vrijwel alle moderne locatiegebaseerde diensten. Denk aan:

- Het tonen van adressen op een kaart
- Het berekenen van routes of afstanden
- Het vinden van voorzieningen in de buurt
- Het analyseren van geografische patronen in datasets
- Het koppelen van administratieve data aan fysieke locaties

Zonder geocodering zouden we locaties slechts als tekst kunnen verwerken, zonder ruimtelijke betekenis.

## Reverse geocoderen

!!! warning "Let op: Reverse geocoderen wordt momenteel nog niet ondersteund door de PDOK Location API."
